...
Item {
    ...
    property color defaultStartingColor : "white";
    property color defaultNotAllowedColor : "gray";
    property color defaultHintColor: "black"
    property color defaultBorderColor: "transparent";
    property color defaultTextColor: "#DD4814";
    property bool boldText: true;
    property color textColor: "#DD4814";
